							...
							<div class="col-xl-10 col-lg-12 col-md-12 d-block mx-auto">
								<div class="item-search-tabs classifieds-content">
									<div class="item-search-menu">
										<ul class="nav">
											<li class=""><a href="#tab1" class="active" data-toggle="tab">Classifieds</a></li>
											<li><a href="#tab2" data-toggle="tab">Business Directory</a></li>
											<li><a href="#tab3" data-toggle="tab">Jobs</a></li>
											<li><a href="#tab4" data-toggle="tab">RealEstate</a></li>
											<li><a href="#tab5" data-toggle="tab">Education</a></li>
											<li><a href="#tab6" data-toggle="tab">Coupons</a></li>
										</ul>
									</div>
